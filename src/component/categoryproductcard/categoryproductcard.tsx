...
export const CategoryProductCard = memo(({ subCategoryName, productList }: { subCategoryName: string, productList: Product[] }) =>
    <React.Fragment>
        {productList && productList.length > 0 ?
            <div className={css($.border_radius(2), $.cs.bg_theme, $.cs.neomorphic_box_shadow_l, $.m_d_rem('Left', 2.4), $.m_d_rem('Right', 2.4), $.cs.col, $.cs.jstfy_content_center, $.cs.align_items_center, $.cs.flex_wrap, $.cs.width_auto, $.max_width(51), $.p_d_rem('Top', 1), $.p_d_rem('Bottom', 2), $.p_d_rem('Left', 0.5), $.p_d_rem('Right', 0.5), $.mcs.width100p)} key={subCategoryName}>
                ...
                <div className={css($.cs.row, $.cs.flex_wrap, $.cs.jstfy_content_center, $.max_width(45), $.cs.width_mx_Content, $.mcs.width100p)}>
                    {productList.map(eachProduct =>
                        ...
                        <Link key={eachProduct.entid} to={`/crit/${eachProduct.subcategory}/${eachProduct.entid}`}>
                            ...
                            <div className={css($.width(20), $.m_rem(0.8), $.border_radius(1.5), localStyles.border_1px_grey)}>
