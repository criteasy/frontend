...
export const CategoryProductCard = memo(({ subCategoryName, productList }: { subCategoryName: string, productList: Product[] }) =>
    <React.Fragment>
        {productList && productList.length > 0 ?
            <div className={css(
                style.border_radius(2).c,
                style.cs.bg_theme,
                style.cs.neomorphic_box_shadow_l,
                style.m_d_rem('Left', 2.4).c,
                style.m_d_rem('Right', 2.4).c,
                style.cs.col,
                style.cs.jstfy_content_center,
                style.cs.align_items_center,
                style.cs.flex_wrap,
                style.cs.width_auto,
                style.max_width(51).c,
                style.p_d_rem('Top', 1).c,
                style.p_d_rem('Bottom', 2).c,
                style.p_d_rem('Left', 0.5).c,
                style.p_d_rem('Right', 0.5).c,
                style.mcs.width100p,
                )} key={subCategoryName}>

                <Link to={`/crit/${subCategoryName}`}>
                    <div className={css(style.cs.txt_align_ctr,
                        style.p_rem(1.5).c,
                        style.cs.bold,
                        style.cs.ff_lato)
                    }>
                ...
                <div className={
                    css(
                        ...
                        style.cs.flex_wrap,
                        style.cs.jstfy_content_center,
                        style.max_width(45).c,
                        style.cs.width_mx_Content,
                        style.mcs.width100p
                        )}>
                        ...
                        <Link key={eachProduct.entid} to={`/crit/${eachProduct.subcategory}/${eachProduct.entid}`}>
                            <div className={css(style.width(20).c, style.m_rem(0.8).c, style.border_radius(1.5).c, localStyles.border_1px_grey,
                                ...
                                <div className={`${css(style.cs.row,
                                    ...
                                    <div className={
                                        css(style.cs.row, style.cs.align_items_center)
                                    }>
                                    ...
                                    <div className={
                                        ...
                                        <span className={css(style.cs.txt_accentLighter,
                                        style.cs.flex_nowrap,
                                        style.cs.jstfy_content_center,
                                        style.cs.align_items_center,
                                        style.m_d_rem('Left',0.5).c,
                                        style.cs.row_inline
                                        )}>
                                            <BsStarFill />
                                        </span>
